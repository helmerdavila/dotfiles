...
# The theme to use.
export TMUX_POWERLINE_THEME="helmer"
...
# sqlite3 -list "/var/folders/xr/1qsyl81x5q5dbv31x29q3_6c0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/helmer/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/helmer/.mailcheckrc"
# }
...
export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="-t 0 -a 0"
# }
